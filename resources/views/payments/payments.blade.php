                    ...
                    <div class="table-responsive">
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'
                            ...
                            <tr>
                                ...
                                <th class="border-bottom-0">رقم العملية </th>
                                <th class="border-bottom-0">اللإشعار</th>
...
{{--                                <th class="border-bottom-0"> العمليات</th>--}}
                            ...
                            @foreach( $payments as $payment)
                                <tr>
                                    ...
                                    <td>{{ $payment ->name}}</td>
                                    <td>{{ $payment ->phone }}</td>
                                    <td>{{ $payment ->process_num}}</td>
                                    <td><img src="{{ $payment->image_path }}" alt="No image available"
        ...
        <div class="modal" id="modaldemo9">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">حذف المدفوعات</h6><button aria-label="Close" class="close" data-dismiss="modal"
...
@section('js')
    ...
    <script>
        ...
        //     modal.find('.modal-body #statement').val(statement);
